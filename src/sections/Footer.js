...
import { Facebook, Instagram, Pinterest, Twitter } from "../components/Icons";

const Footer = () => {
  return (
    <footer className="footer">
      <div className="container footer__container">
        <HashLink smooth className="footer__logo-link" to="#top">
          <svg
        ...
        <ul className="footer__social-links">
          <li className="footer__social-link-wrapper">
            <a
